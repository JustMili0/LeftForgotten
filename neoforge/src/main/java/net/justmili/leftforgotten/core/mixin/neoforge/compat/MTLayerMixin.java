...
// Mixin made and to be maintained by Cyber-Sammy
// JustMili will not maintain or fix it if anything changes
@Pseudo
...
public abstract class MTLayerMixin {
    ...
    @Redirect(method = "lambda$doCreateBiomes$2", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/level/LevelHeightAccessor;getMaxSection()I"), require = 0)
