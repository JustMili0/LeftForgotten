...
public class RemodelFurnace extends FurnaceBlock {
    public RemodelFurnace() {
        super(Properties.of().strength(Block.INDESTRUCTIBLE).noLootTable().noOcclusion().isValidSpawn(BlockBehaviorUtil::no).noParticlesOnBreak().pushReaction(PushReaction.BLOCK).lightLevel(BlockBehaviorUtil.litBlockEmission(13)));
    }
