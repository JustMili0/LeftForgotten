...
public class RemodelCraftingTable extends CraftingTableBlock {
    public RemodelCraftingTable() {
        super(Properties.of().strength(Block.INDESTRUCTIBLE).noLootTable().noOcclusion().isValidSpawn(BlockBehaviorUtil::no).noParticlesOnBreak().pushReaction(PushReaction.BLOCK));
    }
