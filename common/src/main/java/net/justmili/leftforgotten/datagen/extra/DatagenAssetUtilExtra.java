...
public class DatagenAssetUtilExtra {
    ...
    public static void createOldChest(BlockModelGenerators blockGen, Block block) {
        ...
        var leftModel = customBackOrientable.create(ResourceUtil.mapTextureLeft(block),
            leftMapping, blockGen.modelOutput);
        var rightModel = customBackOrientable.create(ResourceUtil.mapTextureRight(block),
